  ...
  return (
    <div className="border-t border-border pt-4 mt-4">
      <button
        ...
        className="flex items-center gap-2 w-full text-left text-sm font-medium text-foreground hover:text-foreground/80"
      >
    ...
    <button
      ...
      className={`w-full text-left p-2 rounded text-xs transition-colors ${
        isSelected
          ...
          : 'bg-border/20 hover:bg-border/40 border border-transparent'
      }`}
    >
...
function ContentDiff({ entry, onClose }: ContentDiffProps) {
  ...
  return (
    <div className="mt-3 p-3 bg-border/20 rounded-lg border border-border">
      ...
      <div className="space-y-2">
        <div>
          <div className="text-xs font-medium text-red-400 mb-1">Previous:</div>
          <div className="text-xs text-foreground bg-red-900/20 p-2 rounded max-h-24 overflow-y-auto">
            {oldText}
          </div>
        </div>

        <div>
          <div className="text-xs font-medium text-green-400 mb-1">New:</div>
          <div className="text-xs text-foreground bg-green-900/20 p-2 rounded max-h-24 overflow-y-auto">
            {newText}
          </div>
        </div>
      </div>
